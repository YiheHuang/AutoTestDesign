...
class RiskAnalyzer:
    ...
    @staticmethod
    def _default_score(level: str) -> int:
        return {"High": 85, "Medium": 60, "Low": 30}.get(level, 50)
        ...
        try:
            ...
            for a in result_list:
                assessments.append(RiskAssessment(
                    ...
                    risk_score=int(a.get("risk_score", self._default_score(a.get("risk_level", "Medium")))),
            ...
            for r in reqs:
                if r.id not in existing_ids:
                    assessments.append(RiskAssessment(
                        requirement_id=r.id,
                        risk_score=self._default_score("Medium"),
                        risk_level="Medium",
            ...
            return [
                RiskAssessment(requirement_id=r.id, risk_score=self._default_score("Medium"),
                               risk_level="Medium", risk_factors=["分析失败(默认)"],
